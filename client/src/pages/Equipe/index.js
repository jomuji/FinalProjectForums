			...
			<LesBios>
				<section>
					...
					<Bio>
						...
						J’étudie l’innovation à HEC Montréal ainsi que le développement web
						à Concordia.
					</Bio>
					<Bio>
				...
				<section>
					...
					<Statement>
						Chez Ailleurs, je m’intéresse à la gouvernance et au financement de
						l'innovation sociale.
					</Statement>
					<Bio>
						Après des études en économie appliquée, j’ai travaillé huit ans
						comme analyste en investissements et conseiller stratégique pour des
						grandes caisses de retraite. J’ai ensuite quitté le milieu de
					...
					<Bio>
						...
						l’apprentissage collectif et l’organisation par et pour les usagers
						dans les systèmes professionnels.
					</Bio>
				</section>
			</LesBios>
		</Wrapper>
